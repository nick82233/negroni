...
{
	[ConfigurationCollection(typeof(ControlFactoryElement), AddItemName = "OpenSocialControlFactory")]
	public class ControlFactoryElementCollection : ConfigurationElementCollection
	{
