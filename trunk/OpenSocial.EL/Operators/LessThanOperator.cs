...
namespace Negroni.OpenSocial.EL.Operators
{
	...
	/// <summary>
	/// Singleton implementation of the less than (<) operator
	/// </summary>
	public class LessThanOperator : BinaryOperator
	{

		private static readonly LessThanOperator instance = new LessThanOperator();

		private LessThanOperator()
			: base(OperatorType.LessThan, AssignmentEnum.Left, 25)
		{
		}
