...
namespace Negroni.OpenSocial.Test.Gadget
{
    ...
    public class OffsetItemTest
    {
		...
		const string GADGET_OFFSET_STRING = "38:GadgetRoot{8:ModulePrefs|55:ContentBlock{36-148:DataScript{28-101:ViewerRequest}|148-293:TemplateScript{32:Literal|100:OsName|130-136:Literal}}}";
