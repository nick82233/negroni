...
{
	public class DataGadgetCrosspointerParams : DataGadgetTestData
	{
		public DataGadgetCrosspointerParams()
		{
			this.Source =
...
<Module>
  ...
  <script type=""text/os-data"">
    ...
    <os:PeopleRequest key='f2' userid=""@viewer"" groupid=""@friends""  count=""${f1.count}""  />
  </script>
