...
namespace Negroni.OpenSocial.EL.Operators
{
	...
	/// <summary>
	/// Singleton implementation of the greater than equals (>=) operator
	/// </summary>
	public class GreaterThanEqualsOperator : BinaryOperator
	{

		private static readonly GreaterThanEqualsOperator instance = new GreaterThanEqualsOperator();


		private GreaterThanEqualsOperator()
			: base(OperatorType.GreaterThanEquals, AssignmentEnum.Left, 25)
		{
		}

		public static GreaterThanEqualsOperator Instance
		{
			get { return instance; }
		}
