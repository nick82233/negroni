...
{
	public class UrlDecodeOperator: FunctionOperator
	{
		
		private static readonly UrlDecodeOperator instance = new UrlDecodeOperator();

		private UrlDecodeOperator() : base(OperatorType.UrlDecode, AssignmentEnum.Right, 10) { }

		public static UrlDecodeOperator Instance
		{
			get{return instance;}
		}
