...
namespace Negroni.OpenSocial.EL.Operators
{
	...
	/// <summary>
	/// Singleton implementation of the inequality (!=) operator
	/// </summary>
	public class NotEqualsOperator : BinaryOperator
	{

		private static readonly NotEqualsOperator instance = new NotEqualsOperator();


		private NotEqualsOperator(): base(OperatorType.NotEquals, AssignmentEnum.Left, 30)
		{
		}

		public static NotEqualsOperator Instance
		{
			get { return instance; }
		}
