...
namespace Negroni.OpenSocial.EL.Operators
{
	...
	/// <summary>
	/// Singleton implementation of the less than equals (<=) operator
	/// </summary>
	public class LessThanEqualsOperator : BinaryOperator
	{

		static readonly LessThanEqualsOperator instance = new LessThanEqualsOperator();

		private LessThanEqualsOperator()
			: base(OperatorType.LessThanEquals, AssignmentEnum.Left, 25)
		{
		}

		public static LessThanEqualsOperator Instance
		{
			get { return instance; }
		}
