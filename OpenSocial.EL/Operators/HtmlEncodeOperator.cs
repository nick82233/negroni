...
{
	public class HtmlEncodeOperator : FunctionOperator
	{
		private static readonly HtmlEncodeOperator instance = new HtmlEncodeOperator();
		
		private HtmlEncodeOperator() : base(OperatorType.HtmlEncode, AssignmentEnum.Right, 10){}
		
		public static HtmlEncodeOperator Instance{
			get{return instance;}
		}
